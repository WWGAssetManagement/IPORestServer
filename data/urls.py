...
from .views import DemandForecastDetailView, DemandForecastView, DemandForecastInProgress
...
urlpatterns = [
    ...
    path('demand/forecast/inprogress', DemandForecastInProgress.as_view()),
]
